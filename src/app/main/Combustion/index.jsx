					...
					<div className="flex md:flex-row flex-col flex-1">
						<div className="flex flex-col md:w-full h-full">
							<div className="flex md:flex-row flex-col w-full flex-1 md:flex-initial md:h-3/5 mb-4">
								<div className="flex flex-col flex-1 md:flex-initial md:w-1/6 mb-8 md:mb-0 ">
								...
								<div className="flex flex-col flex-1 md:flex-initial md:w-3/6 my-4 md:my-0 md:mx-8 space-y-8">
												...
												<div>
													...
													<Grid container>
														...
														<Grid item xs={6}>
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvCurrent
																	? mvCurrent && mvCurrent.burner_tilt_pos1 === null
																		? '-'
																		: Number(
															...
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvBias
																	? mvBias && mvBias.bias_burner_tilt_pos1 === null
																		? '-'
																		: Number(
																			mvBias && mvBias.bias_burner_tilt_pos1
																		).toFixed(2)
																	: '-'}
															</Typography>
														</Grid>
												...
												<div>
													...
													<Grid container>
														...
														<Grid item xs={6}>
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvCurrent
																	? mvCurrent && mvCurrent.burner_tilt_pos2 === null
																		? '-'
																		: Number(
															...
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvBias
																	? mvBias && mvBias.bias_burner_tilt_pos2 === null
																		? '-'
																		: Number(
																			mvBias && mvBias.bias_burner_tilt_pos2
																		).toFixed(2)
																	: '-'}
															</Typography>
														</Grid>
												...
												<div>
													...
													<Grid container>
														...
														<Grid item xs={6}>
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvCurrent
																	? mvCurrent && mvCurrent.burner_tilt_pos3 === null
																		? '-'
																		: Number(
															...
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvBias
																	? mvBias && mvBias.bias_burner_tilt_pos3 === null
																		? '-'
																		: Number(
																			mvBias && mvBias.bias_burner_tilt_pos3
																		).toFixed(2)
																	: '-'}
															</Typography>
														</Grid>
												...
												<div>
													...
													<Grid container>
														...
														<Grid item xs={6}>
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvCurrent
																	? mvCurrent && mvCurrent.burner_tilt_pos4 === null
																		? '-'
																		: Number(
															...
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{mvBias
																	? mvBias && mvBias.bias_burner_tilt_pos4 === null
																		? '-'
																		: Number(
																			mvBias && mvBias.bias_burner_tilt_pos4
																		).toFixed(2)
																	: '-'}
															</Typography>
														</Grid>
													...
													<Grid container>
														<Grid container item xs={12} justify="space-between">
															...
															<Grid item>
																<Typography className="text-8 xl:text-12 font-semibold">
																	{disturbances
																		? disturbances && disturbances.primary_air_flow === null
																			? '-'
																			: Number(
																				disturbances &&
												...
												<div className="mb-4">
													...
													<Grid container>
														...
														<Grid item xs={6}>
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{optimalityParameters
																	? optimalityParameters &&
																		optimalityParameters.actual_excess_outlet_a === null
																		? '-'
																		: Number(
																			optimalityParameters &&
														...
														/{' '}
																{optimalityParameters
																	? optimalityParameters &&
																		optimalityParameters.target_excess_outlet_a === null
																		? '-'
																		: Number(
																			optimalityParameters &&
														...
														<Grid item xs={6}>
															<Typography className="text-8 xl:text-12 font-semibold text-right">
																{optimalityParameters
																	? optimalityParameters &&
																		optimalityParameters.actual_excess_outlet_b === null
																		? '-'
																		: Number(
																			optimalityParameters &&
														...
														/{' '}
																{optimalityParameters
																	? optimalityParameters &&
																		optimalityParameters.target_excess_outlet_b === null
																		? '-'
																		: Number(
																			optimalityParameters &&
								...
								<div className="flex-1 md:flex-initial md:w-2/6 md:h-full flex flex-col justify-between mt-8 md:mt-0">
									<Typography className="text-11 xl:text-14 mb-4 flex-initial">
										Constraints
									</Typography>
									<Paper
										...
										<div className="mb-4">
											...
											<Grid container>
												...
												<Grid item xs={6}>
													<Typography className="text-8 xl:text-12 font-semibold text-right">
														{constraints
															? constraints && constraints.furnace_pressure_a === null
																? '-'
																: Number(
												...
												<Grid item xs={6}>
													<Typography className="text-8 xl:text-12 font-semibold text-right">
														{constraints
															? constraints && constraints.furnace_pressure_b === null
																? '-'
																: Number(
												...
												<Grid item xs={6}>
													<Typography className="text-8 xl:text-12 font-semibold text-right">
														{constraints
															? constraints && constraints.furnace_pressure_c === null
																? '-'
																: Number(
									...
									>
										...
										>
											{o2ChartError ? (
												...
												<TrendChart
													data={o2Chart}
													loading={windboxChartLoading || !constraints}
													height={heightChart}
												/>
											)}
										</Grid>
