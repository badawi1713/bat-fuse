							...
							<div className="flex md:flex-row flex-col w-full flex-1 md:flex-initial md:h-3/5 mb-4">
								<div className="flex flex-col flex-1 md:flex-initial md:w-1/6 mb-8 md:mb-0 ">
									...
									<Paper square className="flex justify-around flex-col flex-1 p-8 overflow-auto">
										<div>
											{constraints ? (
												constraints && constraints.constraints_messages === '' && constraints && constraints.constraints_messages !== undefined ? (
											...
											) : constraints && constraints.constraints_messages === undefined ?
												<p className="text-11 xl:text-16 font-semibold text-grey-100 text-center">
													No messages to display.
											</p> :
												(
									...
									>
										...
										>
											{o2ChartError ? (
												...
												<TrendChart
													data={o2Chart}
													loading={windboxChartLoading || !constraintLimit}
													height={heightChart}
												/>
											)}
										</Grid>
