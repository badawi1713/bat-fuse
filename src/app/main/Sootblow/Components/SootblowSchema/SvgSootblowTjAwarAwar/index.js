...
function SvgSootblowTjAwarAwar(props) {
	...
	const indicator101 = indicator[101] || '#FFF000';
	const indicator102 = indicator[102] || '#FFF000';
	const indicator103 = indicator[103] || '#FFF000';
	const indicator104 = indicator[104] || '#FFF000';
	const indicator105 = indicator[105] || '#FFF000';
	const indicator106 = indicator[106] || '#FFF000';
	const indicator107 = indicator[107] || '#FFF000';
	const indicator108 = indicator[108] || '#FFF000';
	const indicator109 = indicator[109] || '#FFF000';
	const indicator110 = indicator[110] || '#FFF000';
	const indicator111 = indicator[111] || '#FFF000';
	const indicator112 = indicator[112] || '#FFF000';
	const indicator113 = indicator[113] || '#FFF000';
	const indicator114 = indicator[114] || '#FFF000';
	const indicator115 = indicator[115] || '#FFF000';
	const indicator116 = indicator[116] || '#FFF000';
	const indicator117 = indicator[117] || '#FFF000';
	const indicator118 = indicator[118] || '#FFF000';
	const indicator119 = indicator[119] || '#FFF000';
	const indicator120 = indicator[120] || '#FFF000';

	const indicator201 = indicator[201] || '#FFF000';
	const indicator202 = indicator[202] || '#FFF000';
	const indicator203 = indicator[203] || '#FFF000';
	const indicator204 = indicator[204] || '#FFF000';
	const indicator205 = indicator[205] || '#FFF000';
	const indicator206 = indicator[206] || '#FFF000';
	const indicator207 = indicator[207] || '#FFF000';
	const indicator208 = indicator[208] || '#FFF000';
	const indicator209 = indicator[209] || '#FFF000';
	const indicator210 = indicator[210] || '#FFF000';
	const indicator211 = indicator[211] || '#FFF000';
	const indicator212 = indicator[212] || '#FFF000';
	const indicator213 = indicator[213] || '#FFF000';
	const indicator214 = indicator[214] || '#FFF000';
	const indicator215 = indicator[215] || '#FFF000';
	const indicator216 = indicator[216] || '#FFF000';
	const indicator217 = indicator[217] || '#FFF000';
	const indicator218 = indicator[218] || '#FFF000';
	const indicator219 = indicator[219] || '#FFF000';
	const indicator220 = indicator[220] || '#FFF000';

	const indicator301 = indicator[301] || '#FFF000';
	const indicator302 = indicator[302] || '#FFF000';
	const indicator303 = indicator[303] || '#FFF000';
	const indicator304 = indicator[304] || '#FFF000';
	const indicator305 = indicator[305] || '#FFF000';
	const indicator306 = indicator[306] || '#FFF000';
	const indicator307 = indicator[307] || '#FFF000';
	const indicator308 = indicator[308] || '#FFF000';
	const indicator309 = indicator[309] || '#FFF000';
	const indicator310 = indicator[310] || '#FFF000';
	const indicator311 = indicator[311] || '#FFF000';
	const indicator312 = indicator[312] || '#FFF000';
	const indicator313 = indicator[313] || '#FFF000';
	const indicator314 = indicator[314] || '#FFF000';
	const indicator315 = indicator[315] || '#FFF000';
	const indicator316 = indicator[316] || '#FFF000';
	const indicator317 = indicator[317] || '#FFF000';
	const indicator318 = indicator[318] || '#FFF000';
	const indicator319 = indicator[319] || '#FFF000';
	const indicator320 = indicator[320] || '#FFF000';

	const indicator401 = indicator[401] || '#FFF000';
	const indicator402 = indicator[402] || '#FFF000';
	const indicator403 = indicator[403] || '#FFF000';
	const indicator404 = indicator[404] || '#FFF000';
	const indicator405 = indicator[405] || '#FFF000';
	const indicator406 = indicator[406] || '#FFF000';
	const indicator407 = indicator[407] || '#FFF000';
	const indicator408 = indicator[408] || '#FFF000';
	const indicator409 = indicator[409] || '#FFF000';
	const indicator410 = indicator[410] || '#FFF000';
	const indicator411 = indicator[411] || '#FFF000';
	const indicator412 = indicator[412] || '#FFF000';
	const indicator413 = indicator[413] || '#FFF000';
	const indicator414 = indicator[414] || '#FFF000';
	const indicator415 = indicator[415] || '#FFF000';
	const indicator416 = indicator[416] || '#FFF000';
	const indicator417 = indicator[417] || '#FFF000';
	const indicator418 = indicator[418] || '#FFF000';
	const indicator419 = indicator[419] || '#FFF000';
	const indicator420 = indicator[420] || '#FFF000';

	const indicator501 = indicator[501] || '#FFF000';
	const indicator502 = indicator[502] || '#FFF000';
	const indicator503 = indicator[503] || '#FFF000';
	const indicator504 = indicator[504] || '#FFF000';

	const indicator601 = indicator[601] || '#FFF000';
	const indicator602 = indicator[602] || '#FFF000';
	const indicator603 = indicator[603] || '#FFF000';
	const indicator604 = indicator[604] || '#FFF000';

	const indicator701 = indicator[701] || '#FFF000';
	const indicator702 = indicator[702] || '#FFF000';
	const indicator703 = indicator[703] || '#FFF000';
	const indicator704 = indicator[704] || '#FFF000';
	const indicator705 = indicator[705] || '#FFF000';
	const indicator706 = indicator[706] || '#FFF000';
	const indicator707 = indicator[707] || '#FFF000';
	const indicator708 = indicator[708] || '#FFF000';
	const indicator709 = indicator[709] || '#FFF000';
	const indicator710 = indicator[710] || '#FFF000';
	const indicator711 = indicator[711] || '#FFF000';
	const indicator712 = indicator[712] || '#FFF000';
	const indicator713 = indicator[713] || '#FFF000';

	const indicator801 = indicator[801] || '#FFF000';
	const indicator802 = indicator[802] || '#FFF000';
	const indicator803 = indicator[803] || '#FFF000';
	const indicator804 = indicator[804] || '#FFF000';
	const indicator805 = indicator[805] || '#FFF000';
	const indicator806 = indicator[806] || '#FFF000';
	const indicator807 = indicator[807] || '#FFF000';
	const indicator808 = indicator[808] || '#FFF000';
	const indicator809 = indicator[809] || '#FFF000';
	const indicator810 = indicator[810] || '#FFF000';
	const indicator811 = indicator[811] || '#FFF000';
	const indicator812 = indicator[812] || '#FFF000';
	const indicator813 = indicator[813] || '#FFF000';

	const indicator901 = indicator[901] || '#FFF000';
	const indicator902 = indicator[902] || '#FFF000';
